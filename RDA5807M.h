...
class RDA5807M
{
    public:
        ...
        */
        ...
        bool setVolume(const byte volume);
        ...
        *          band.
        */
        void seekUp(bool wrap = true, void (*showFunc)(word currentFrequency) = nullptr);
        ...
        *          band.
        */
        void seekDown(bool wrap = true, void (*showFunc)(word currentFrequency) = nullptr);
